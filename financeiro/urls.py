...
urlpatterns = [
    ...
    path('contas/editar-conta/<int:pk>/', views.conta_update, name='conta_update'),
    path('contas/excluir-conta/<int:pk>/', views.conta_delete, name='conta_delete'),
    ...
    # Rota de Documentos (Recibo) - Esta era a linha que causava o erro (Linha 30 no seu arquivo local)
